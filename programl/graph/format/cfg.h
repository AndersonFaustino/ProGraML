// This file defines a converter from ProGraML graph representation to CFG.
// The CFG representation is described in:
//
...
class CFGBuilder {
 public:
  ...
  // Construct a CFG from the given ProGraML graph.
  [[nodiscard]] ProgramGraph Build(const ProgramGraph& graph);

  // Return a list of node indices used to create the CFG. For example, given a
  // mapping from input graph to CFG graph nodes of:
  //
  //     {
  //      1: -
  //      2: 0
